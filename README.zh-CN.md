...
> **注意** — 本仓库包含 Oxmux 的开源社区版。部分平台能力——托管模型网关、按用量计费、托管云节点池与合作商系统——作为独立商业服务运营，**不包含在本仓库中**。本仓库所有内容在 Apache-2.0 下免费使用。完整对照见 [开源 vs 商业托管](#开源-vs-商业托管)。
...
| Admin 控制台（用户 / 反馈 / 运营） | ✅ | 计费 / 积分 / 网关 / 合作商面板 |
| 原生客户端（Electron 桌面 + React Native Android/iOS） | ✅ | — |
| 托管模型网关（官方模型目录） | — | ✅ |
| 云节点（托管沙箱 worker 池） | — | 托管池 |
| 订阅 / 按量计费、积分与支付 | — | ✅ |
| 合作商系统 | — | ✅ |
...
**真的免费吗？**
是的。本仓库所有内容都是 Apache-2.0。只有独立运营的托管服务——模型网关、托管云节点池、计费、合作商系统——是商业的，而且都不在本仓库中。
