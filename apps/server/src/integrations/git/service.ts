...
import { buildOxmuxAgentCommitMessage, resolveOxmuxAutomatedCommitAuthor } from '@shared/git-commit-message'
...
export const finalizeTaskWorktreeGit = async (params: {
  ...
  try {
    ...
    const commitAuthor = resolveOxmuxAutomatedCommitAuthor(params.identity) ?? params.identity
