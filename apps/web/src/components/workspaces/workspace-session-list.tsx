          ...
          {visibleWorkspaceSessions.map(({ session: item, depth }) => {
            ...
            return (
              <div
                ...
                onDrop={(event) => {
                  const droppedWorkspaceSessionId = event.dataTransfer.getData('application/x-oxmux-workspace-session')
              ...
              >
                ...
                <button
                  ...
                  onDragStart={(event) => {
                    ...
                    event.dataTransfer.setData('application/x-oxmux-workspace-session', item.id)
