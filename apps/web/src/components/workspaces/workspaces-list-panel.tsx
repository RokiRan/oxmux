              ...
              >
                <button
                  ...
                  onDragStart={(event) => {
                    ...
                    event.dataTransfer.setData('application/x-oxmux-project', group.project.id)
                  ...
                  {group.items.map((item) => (
                    <WorkspaceListCard
                      ...
                      onDragStart={(event) => {
                        ...
                        event.dataTransfer.effectAllowed = 'move'
                        event.dataTransfer.setData('application/x-oxmux-workspace', item.workspace.id)
                        event.dataTransfer.setData('application/x-oxmux-workspace-project', group.project.id)
                      ...
                      onDrop={(event) => {
                        ...
                        event.preventDefault()
                        const droppedWorkspaceId = event.dataTransfer.getData('application/x-oxmux-workspace') || draggedWorkspaceItem.workspaceId
                        const droppedProjectId = event.dataTransfer.getData('application/x-oxmux-workspace-project') || draggedWorkspaceItem.projectId
                        const nextPosition = resolveWorkspaceListDropPosition(event)
                        const nextOrderedWorkspaceIds = reorderWorkspaceListIds(
                          group.items.map((workspaceItem) => workspaceItem.workspace.id),
                          droppedWorkspaceId,
    ...
    items.map((item) => (
      <WorkspaceListCard
        ...
        onDragStart={(event) => {
          ...
          event.dataTransfer.effectAllowed = 'move'
          event.dataTransfer.setData('application/x-oxmux-workspace', item.workspace.id)
          event.dataTransfer.setData('application/x-oxmux-workspace-project', item.project.id)
          event.dataTransfer.setData('text/plain', item.workspace.id)
          applyWorkspaceListRowDragImage(event)
          requestAnimationFrame(() => {
            setDraggedWorkspaceItem({
