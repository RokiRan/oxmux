...
1. Treat requests as tasks, not just prompts.
2. Route work to the machine that can actually run it.
3. Preserve logs, branches, and execution evidence.
4. Keep humans in the approval loop.
5. Let work continue across sessions, devices, and hosts.
