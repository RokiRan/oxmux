...
- direct coding interaction
- strong implementation workflow
- terminal or runtime-native execution
- good fit for one developer driving a coding session closely
...
- preserve task visibility outside one local session
- keep logs, branches, and review context visible
- continue the work when the current machine becomes unavailable
