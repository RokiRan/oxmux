...
- desktop-native execution ergonomics
- SSH worktree workflows for remote machines
- design-mode and browser feedback loops for frontend work
...
- visible task flow across intake, execution, review, and follow-up
- team-aware delivery instead of only single-user worktrees
- stronger room for scheduler, transfer, and persistent multi-machine execution

That difference matters in practice. A team usually does not just need an elegant worktree UI. It needs a way to decide what should run, where it should run, who can inspect it, and how work continues when one device becomes unavailable.
...
| Execution model | Local desktop plus SSH-connected remote worktrees | Routed workers, real repos, and execution ownership across nodes |
| Review surface | Strong built-in diff and PR workflow | Stronger long-term direction around routed delivery, control, and task visibility |
| Team model | Limited team depth compared with control-plane products | Explicitly aligned with team delivery and shared execution context |
| Device continuity | Strong for desktop workflows | Stronger direction for persistent work across changing machines and long-running tasks |
