...
1. The task stays visible to the team.
2. Execution is routed to the right worker or host.
3. The result comes back with logs, branch output, and review context.
4. Another teammate can inspect, redirect, or continue it later.
5. The work survives device changes and handoff.
