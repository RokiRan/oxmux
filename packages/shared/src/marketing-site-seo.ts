...
const staticIndexedMarketingPages = [
  {
    path: '/pricing',
    title: 'oxmux Pricing for Pro and Team Workflows',
    description: 'Public oxmux pricing for Free, Pro, and Team plans, including monthly plan differences and what each tier unlocks before checkout.',
  ...
  {
    path: '/privacy',
    title: 'oxmux Privacy Policy',
    description: 'How oxmux handles account data, repositories, execution logs, worker metadata, and communications for the AI delivery platform.',
    lastModified: siteSeoLastUpdated,
    changeFrequency: 'weekly',
    priority: 0.6,
  },
  {
    path: '/terms',
    title: 'oxmux Terms of Service',
    description: 'The public terms for accessing oxmux, including acceptable use, billing, beta limitations, and responsibilities when running AI delivery workflows.',
    lastModified: siteSeoLastUpdated,
    changeFrequency: 'weekly',
    priority: 0.6,
  },
  {
    ...
    description: 'oxmux is the AI-native operating system for your organization: plan tasks on a distributed kanban board, command agent teams, route workers, track execution, and review results across teams, projects, and organizations.',
    lastModified: siteSeoLastUpdated,
    changeFrequency: 'weekly',
    priority: 1.0,
  },
  {
    path: '/faq',
    title: 'oxmux FAQ for AI Coding Teams',
    description: 'Answers for teams evaluating oxmux: what it does, where workers run, why it is not another AI chat demo, and how it fits real delivery workflows.',
    lastModified: siteSeoLastUpdated,
    changeFrequency: 'weekly',
    priority: 0.8,
  },
  {
    path: '/blog',
    title: 'oxmux Blog',
    description: 'oxmux founder notes and SEO articles about AI coding delivery, persistent execution, remote handoff, and real workstation workflows.',
    lastModified: siteSeoLastUpdated,
    changeFrequency: 'weekly',
    priority: 0.7,
  },
  ...
  {
    path: '/download',
    title: 'Download the oxmux Desktop App',
    description: 'Download the oxmux desktop client for macOS, Windows, and Linux, with version info and release notes for the current build.',
    lastModified: siteSeoLastUpdated,
    changeFrequency: 'weekly',
    priority: 0.8,
  },
  {
    ...
    title: 'Install a oxmux Worker and Complete Your First Pairing',
    description: 'The shortest public oxmux worker install path for beta users: generate a connect command, run it on the target machine, and finish the first task flow.',
    lastModified: siteSeoLastUpdated,
    changeFrequency: 'weekly',
    priority: 0.8,
  },
  ...
  },
  {
    ...
    description: 'Topic hubs that connect oxmux blog posts, compare pages, and use cases into coherent AI coding SEO clusters.',
    lastModified: siteSeoLastUpdated,
    changeFrequency: 'weekly',
    priority: 0.7,
  },
